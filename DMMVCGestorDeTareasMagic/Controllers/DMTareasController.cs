...
namespace DMMVCGestorDeTareasMagic.Controllers
{
    public class DMTareasController : Controller
    {
        private readonly DMMVCGestorDeTareasMagicContext _context;

        public DMTareasController(DMMVCGestorDeTareasMagicContext context)
        {
            _context = context;
        }
        ...
        {
            var dMMVCGestorDeTareasMagicContext = _context.DMTarea.Include(d => d.DMPrioridad);
